...
android {
    ...
    // Load local key.properties if present (keystore for signing release builds)
    ...
    buildTypes {
        release {
            // Use the release signing config if provided, otherwise fall back to debug (local testing)
            if (keystorePropertiesFile.exists()) {
